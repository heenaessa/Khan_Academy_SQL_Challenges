...
INSERT INTO documents (author, title, content)
    VALUES ('Puff T.M. Dragon', 'Living Things', 'They are located in the left ear, you know.');
INSERT INTO documents (author, title, content)
    VALUES ('Jackie Paper', 'Pirate Recipes', 'Cherry pie, apple pie, blueberry pie.');
INSERT INTO documents (author, title, content)
    VALUES ('Jackie Paper', 'Boat Supplies', 'Rudder - guitar. Main mast - bed post.');
INSERT INTO documents (author, title, content)
    VALUES ('Jackie Paper', 'Things I am Afraid Of', 'Talking to my parents, the sea, giant pirates, heights.');
...
WHERE title = 'Things I am Afraid Of';
